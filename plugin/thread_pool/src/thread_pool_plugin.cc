...
static inline std::optional<std::string> get_system_variable_value(
    ...
    const std::string_view name [[maybe_unused]]) {
  // mysql_system_variable_reader isn't available on this branch; assume
  // not-container-aware rather than reading the actual sysvar.
